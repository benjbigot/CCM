...
if __name__ == '__main__':
	...
	parser.add_option("-f", "--fileList", dest="fileList" , help="two-columns file list col1=filename col2=class_label") 
	...
	if collocation == False :
		...
		listLabel, content = utilsCCM.loadContentAndTags(fileList)
